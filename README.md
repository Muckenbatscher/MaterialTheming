...
[![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/Muckenbatscher/MaterialTheming/official_commit_verify.yml?branch=master&label=up-to-date)](https://github.com/Muckenbatscher/MaterialTheming/actions/workflows/official_commit_verify.yml)
...
All test expectations were [programmatically generated directly from the official Java library results](https://github.com/Muckenbatscher/material-color-utilities-testcases-generation/blob/main/java/MyTest.java), 
ensuring that the colors you generate in .NET are identical to those generated by the official Java implementation.
