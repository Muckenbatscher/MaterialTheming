...
internal class DarkMode_MediumContrast_Spec2021_Yellow : ITestTheme
{
    ...
    // Tertiary
    public string Tertiary => "#A6EE95";
    public string OnTertiary => "#002D01";
    public string TertiaryContainer => "#77BC69";
    public string OnTertiaryContainer => "#002801";
    // Error
    ...
    public string OnTertiaryFixed => "#001600";
    public string TertiaryFixedDim => "#91D881";
    public string OnTertiaryFixedVariant => "#004002";
    // Surface Container
