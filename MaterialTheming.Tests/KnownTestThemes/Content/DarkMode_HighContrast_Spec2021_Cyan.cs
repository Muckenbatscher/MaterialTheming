...
internal class DarkMode_HighContrast_Spec2021_Cyan : ITestTheme
{
    ...
    // Tertiary
    public string Tertiary => "#FCEAFF";
    public string OnTertiary => "#000000";
    public string TertiaryContainer => "#E4AFFF";
    public string OnTertiaryContainer => "#180027";
    // Error
    ...
    public string OnTertiaryFixedVariant => "#210034";
    // Surface Container
