...
internal class DarkMode_HighContrast_Spec2025_Magenta : ITestTheme
{
    ...
    // Tertiary
    public string Tertiary => "#FFECE8";
    public string OnTertiary => "#000000";
    public string TertiaryContainer => "#FFAF9E";
    public string OnTertiaryContainer => "#200100";
    // Error
    ...
    public string OnTertiaryFixedVariant => "#2B0200";
    // Surface Container
