...
internal class DarkMode_MediumContrast_Spec2026_Blue : ITestTheme
{
    ...
    // Tertiary
    public string Tertiary => "#FFD4B8";
    public string OnTertiary => "#3F1C00";
    public string TertiaryContainer => "#D37A34";
    ...
    public string OnTertiaryFixed => "#210B00";
    public string TertiaryFixedDim => "#FFB785";
    public string OnTertiaryFixedVariant => "#582900";
    // Surface Container
