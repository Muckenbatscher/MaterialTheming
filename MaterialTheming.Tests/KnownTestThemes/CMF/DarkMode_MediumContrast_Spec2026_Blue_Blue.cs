...
internal class DarkMode_MediumContrast_Spec2026_Blue_Blue : ITestThemeSecondSourceColor
{
    ...
    // Tertiary
    public string Tertiary => "#96BAF3";
    public string OnTertiary => "#002C58";
    public string TertiaryContainer => "#5276AA";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#5276AA";
    public string OnTertiaryFixed => "#FFFFFF";
    public string TertiaryFixedDim => "#5377AB";
