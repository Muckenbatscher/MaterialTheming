...
internal class DarkMode_HighContrast_Spec2026_Red_Red : ITestThemeSecondSourceColor
{
    ...
    public string TertiaryContainer => "#F98075";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#F98075";
    public string OnTertiaryFixed => "#000000";
    public string TertiaryFixedDim => "#F98075";
