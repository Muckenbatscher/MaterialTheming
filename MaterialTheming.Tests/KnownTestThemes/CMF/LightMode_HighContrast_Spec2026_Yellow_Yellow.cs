...
internal class LightMode_HighContrast_Spec2026_Yellow_Yellow : ITestThemeSecondSourceColor
{
    ...
    public string OnTertiary => "#E1DE83";
    public string TertiaryContainer => "#565504";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#565504";
