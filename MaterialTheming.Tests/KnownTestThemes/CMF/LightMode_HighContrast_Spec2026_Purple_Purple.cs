...
internal class LightMode_HighContrast_Spec2026_Purple_Purple : ITestThemeSecondSourceColor
{
    ...
    // Tertiary
    public string Tertiary => "#340D59";
    public string OnTertiary => "#EAD0FF";
    public string TertiaryContainer => "#66418B";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#66418B";
    public string OnTertiaryFixed => "#FFFFFF";
    public string TertiaryFixedDim => "#59357E";
