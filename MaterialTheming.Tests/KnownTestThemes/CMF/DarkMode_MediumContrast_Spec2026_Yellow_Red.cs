...
internal class DarkMode_MediumContrast_Spec2026_Yellow_Red : ITestThemeSecondSourceColor
{
    ...
    // Error
    public string Error => "#FF9E9C";
    public string OnError => "#5B0C13";
    public string ErrorContainer => "#BA5554";
    ...
    public string TertiaryFixedDim => "#D0443C";
