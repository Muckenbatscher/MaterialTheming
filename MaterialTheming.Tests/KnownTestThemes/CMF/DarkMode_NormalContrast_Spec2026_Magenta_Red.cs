...
internal class DarkMode_NormalContrast_Spec2026_Magenta_Red : ITestThemeSecondSourceColor
{
    ...
    public string ErrorContainer => "#931E00";
    public string OnErrorContainer => "#FFCCC0";
    // Surface
