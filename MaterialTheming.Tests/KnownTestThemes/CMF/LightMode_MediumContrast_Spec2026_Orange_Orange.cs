...
internal class LightMode_MediumContrast_Spec2026_Orange_Orange : ITestThemeSecondSourceColor
{
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#A86437";
    public string OnTertiaryFixed => "#FFFFFF";
    public string TertiaryFixedDim => "#99582C";
