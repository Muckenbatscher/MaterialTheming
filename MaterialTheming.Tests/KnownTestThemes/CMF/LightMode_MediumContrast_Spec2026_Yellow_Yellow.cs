...
internal class LightMode_MediumContrast_Spec2026_Yellow_Yellow : ITestThemeSecondSourceColor
{
    ...
    public string OnTertiary => "#E0DE83";
    public string TertiaryContainer => "#797828";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#797828";
    public string OnTertiaryFixed => "#FFFFFF";
    public string TertiaryFixedDim => "#6C6B1D";
