...
internal class LightMode_NormalContrast_Spec2026_Purple_Green : ITestThemeSecondSourceColor
{
    ...
    // Error
    public string Error => "#A83643";
    public string OnError => "#FFF7F6";
    public string ErrorContainer => "#FA737D";
    public string OnErrorContainer => "#49000E";
    // Surface
    ...
    public string OnTertiaryFixedVariant => "#F7FFF2";
    // Surface Container
