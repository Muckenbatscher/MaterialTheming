...
internal class LightMode_HighContrast_Spec2026_Green_Green : ITestThemeSecondSourceColor
{
    ...
    public string OnTertiary => "#ADE9AF";
    public string TertiaryContainer => "#275D31";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#275D31";
    public string OnTertiaryFixed => "#FFFFFF";
    public string TertiaryFixedDim => "#1A5126";
