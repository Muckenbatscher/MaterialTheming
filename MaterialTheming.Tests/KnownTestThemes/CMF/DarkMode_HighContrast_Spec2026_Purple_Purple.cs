...
internal class DarkMode_HighContrast_Spec2026_Purple_Purple : ITestThemeSecondSourceColor
{
    ...
    public string OnTertiary => "#3D1861";
    public string TertiaryContainer => "#BB93E3";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#BB93E3";
    public string OnTertiaryFixed => "#000000";
    public string TertiaryFixedDim => "#BB93E3";
