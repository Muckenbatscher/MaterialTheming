...
internal class DarkMode_HighContrast_Spec2026_Yellow_Magenta : ITestThemeSecondSourceColor
{
    ...
    public string OnTertiary => "#5A003D";
    public string TertiaryContainer => "#FF71C2";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#FF71C2";
    public string OnTertiaryFixed => "#000000";
    public string TertiaryFixedDim => "#FF71C2";
