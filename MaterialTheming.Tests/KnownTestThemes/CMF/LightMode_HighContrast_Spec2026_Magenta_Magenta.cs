...
internal class LightMode_HighContrast_Spec2026_Magenta_Magenta : ITestThemeSecondSourceColor
{
    ...
    public string TertiaryContainer => "#893165";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#893165";
    public string OnTertiaryFixed => "#FFFFFF";
    public string TertiaryFixedDim => "#7B2459";
