...
internal class DarkMode_NormalContrast_Spec2026_Yellow_Yellow : ITestThemeSecondSourceColor
{
    ...
    // Tertiary
    public string Tertiary => "#B1AF5A";
    public string OnTertiary => "#2F2E00";
    public string TertiaryContainer => "#A3A24E";
