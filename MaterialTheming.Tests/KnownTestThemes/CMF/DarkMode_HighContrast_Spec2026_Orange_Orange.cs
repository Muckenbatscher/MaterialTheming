...
internal class DarkMode_HighContrast_Spec2026_Orange_Orange : ITestThemeSecondSourceColor
{
    ...
    public string TertiaryContainer => "#DF9161";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#DF9161";
    public string OnTertiaryFixed => "#000000";
    public string TertiaryFixedDim => "#DF9161";
