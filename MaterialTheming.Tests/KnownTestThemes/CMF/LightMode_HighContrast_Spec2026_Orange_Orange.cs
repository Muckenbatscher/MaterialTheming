...
internal class LightMode_HighContrast_Spec2026_Orange_Orange : ITestThemeSecondSourceColor
{
    ...
    public string TertiaryContainer => "#7E4218";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#7E4218";
    public string OnTertiaryFixed => "#FFFFFF";
    public string TertiaryFixedDim => "#70370D";
