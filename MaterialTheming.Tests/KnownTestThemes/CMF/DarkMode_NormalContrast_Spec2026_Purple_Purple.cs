...
internal class DarkMode_NormalContrast_Spec2026_Purple_Purple : ITestThemeSecondSourceColor
{
    ...
    // Tertiary
    public string Tertiary => "#B58DDD";
    public string OnTertiary => "#300755";
    public string TertiaryContainer => "#8A64B0";
    public string OnTertiaryContainer => "#FFFFFF";
    // Error
    public string Error => "#FE776F";
    public string OnError => "#4F0005";
    public string ErrorContainer => "#640209";
    public string OnErrorContainer => "#FF8D85";
    // Surface
