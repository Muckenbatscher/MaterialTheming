...
internal class DarkMode_MediumContrast_Spec2026_Purple_Purple : ITestThemeSecondSourceColor
{
    ...
    // Tertiary
    public string Tertiary => "#D1A7FA";
    public string OnTertiary => "#3D1862";
    ...
    public string TertiaryFixedDim => "#8B65B1";
