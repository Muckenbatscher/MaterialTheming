...
internal class LightMode_HighContrast_Spec2026_Blue_Blue : ITestThemeSecondSourceColor
{
    ...
    public string TertiaryContainer => "#2D5385";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#2D5385";
    public string OnTertiaryFixed => "#FFFFFF";
    public string TertiaryFixedDim => "#1F4779";
