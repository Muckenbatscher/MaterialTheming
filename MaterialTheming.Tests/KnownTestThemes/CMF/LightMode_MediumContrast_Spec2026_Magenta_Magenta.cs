...
internal class LightMode_MediumContrast_Spec2026_Magenta_Magenta : ITestThemeSecondSourceColor
{
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#B35389";
    public string OnTertiaryFixed => "#FFFFFF";
    public string TertiaryFixedDim => "#A4477C";
