...
internal class DarkMode_HighContrast_Spec2026_Magenta_Blue : ITestThemeSecondSourceColor
{
    ...
    public string TertiaryContainer => "#6DA5F5";
    ...
    // Tertiary Fixed
    public string TertiaryFixed => "#6DA5F5";
    public string OnTertiaryFixed => "#000000";
    public string TertiaryFixedDim => "#6DA5F5";
