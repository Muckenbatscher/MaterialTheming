...
{
    /// <summary>
    /// Specify the <see href="https://material-foundation.github.io/material-theme-builder/">material theme builder</see> JSON content that is used to build the <see cref="Theme" />.
    /// </summary>
